		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav nav-main">
					...
					<li class="active"><a href="<?php echo DIRPAGE . "/about" ?>">Sobre</a></li>
					...
					<ul class="blog-zone">
						<li>
							...
							<p align=justify style="text-indent:20px">
								<h3>HISTÓRIA</h3>
								<p align=justify style="text-indent:20px">
									Em 1960 o engenheiro agrônomo Francisco Athayde e sua esposa Lêda
									adquiriram o sítio Santa Iria para sua moradia e sustento.
									Hoje a propriedade está com o filho Pedro José e tornou-se uma Agro
									com um centro de pesquisa agrícola, laboratório, alambique, forno de
									produção do melado, rapadura e açúcar mascavo, apiário e casa do mel,
									estufa de mudas, glebas de cana de açúcar desenvolvidas pelo método
									smp, plantas medicinais, espaço de galinhas caipiras, energia solar, etc.
								</p>

								<h3>PRODUTOS</h3>
								<p align=justify style="text-indent:20px">
									Mudas, Cachaça artesanal, Melado, Rapadura, Açúcar mascavo, Mel,
									Própolis, Horta, Ovos caipira, Fubá, Chás, tinturas, alcoolaturas, xaropes e
									temperos de plantas medicinais, Fertilizantes e defensivos de pragas.
									Todos os produtos são agroecológicos.
								</p>

								<h3>CENTRO DE PESQUISA</h3>
								<p align=justify style="text-indent:20px">
									Onde realizamos nossas pesquisas, desenvolvimentos, estudos,
									experimentos e melhoramentos da nossa produção.
								</p>
								<div class="text-center">
									<img style="height:500px; width:300px;" src="images/centro.jpeg" alt="">
								</div>
