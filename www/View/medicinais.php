						...
						<li>
							...
							<p>
								...
								<p align=justify style="text-indent: 20px;">
									Em todo o mundo, cresce a preocupação com o meio ambiente e a busca por produtos com
									ingredientes naturais obtidos de maneira sustentável. Essa busca estende-se a várias
									áreas como
									alimentos, medicamentos, cosméticos e outros. As plantas medicinais, aromáticas e
									condimentares
									formam um grupo de espécies que tem sido alvo constante desse interesse.
								...
								<p align=justify style="text-indent: 20px;">
									...
									plantas
									medicinais já utilizadas pela própria população referendam o uso de nossos recursos
									naturais e de
									espécies exóticas e ajudam a enfrentar os elevados preços dos medicamentos e a
									dependência
									externa nesta área oferecendo uma opção terapêutica.
								</p>


								<h5 style="text-indent: 20px;">Neem Indiano</h5>
								<p align=justify style="text-indent: 20px;">
									O Neem indiano, também conhecido como amargosa é uma arvore
									originaria da Índia, já em cultivo no Brasil, com reconhecidas propriedades
									medicinais, sendo, porém, na agricultura, utilizada para controle de pragas
									e doenças.
								</p>
